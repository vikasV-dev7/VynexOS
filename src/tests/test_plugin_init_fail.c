...
VynexPluginManifest vynex_plugin_get_manifest(void) {
    ...
    m.plugin_name = "InitFailTestPlugin";
    m.description = "Fails initialization";
    m.version.major = 1; m.version.minor = 0; m.version.patch = 0;
    m.required_os_version.major = 1; m.required_os_version.minor = 0; m.required_os_version.patch = 0;
    return m;
}

bool vynex_plugin_create(void) { return true; }
bool vynex_plugin_initialize(const VynexPluginContext* ctx) { (void)ctx; return false; } // Fail here!
